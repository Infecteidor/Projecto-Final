/* Semestre 2024-1
Proyecto final por Gonzalez Peña Jared
La textura del skybox fue conseguida desde la página https://opengameart.org/content/spacemoon-skybox
editada en gimp 2.03
...
int main()
{
	...
	Arcade = Model();
	Arcade.LoadModel("Models/CuartoArcadeFinal.obj");
	Pinball = Model();
	Pinball.LoadModel("Models/maquinaPinball3.obj");



	std::vector<std::string> skyboxFaces;
	skyboxFaces.push_back("Textures/Skybox/indigo_rt.jpg");
	skyboxFaces.push_back("Textures/Skybox/indigo_lf.jpg");
	skyboxFaces.push_back("Textures/Skybox/indigo_dn.jpg");
	skyboxFaces.push_back("Textures/Skybox/indigo_up.jpg");
	skyboxFaces.push_back("Textures/Skybox/indigo_bk.jpg");
	skyboxFaces.push_back("Textures/Skybox/indigo_ft.jpg");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*lastTime = now;*/
		if ((now - lastTime) >= limitFPS) //Solo para cosas que quiero que se metan a 60fps?
		{
			animate();
			lastTime = now;
		}
